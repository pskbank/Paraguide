...
// compile option:  gcc -o vipserver vipserver.c -lbluetooth -lpthread
**************************************************************************/
#include <sys/types.h>
#include <sys/stat.h>
#include <fcntl.h>
...
//*************************************************************************************
// Thread request_pcaccess function  - updated by pskbank  2013-07-17
//*************************************************************************************
void request_pcnotification( dnode *s)
{
    int sockfd;
    ...
    servaddr.sin_addr.s_addr = inet_addr("10.1.1.9");
    servaddr.sin_family = AF_INET;
    servaddr.sin_port = htons(8888);
    memset(sendline,0,sizeof(sendline));

    snprintf(sendline, MAXSUB,"%s\0",s->addr);
